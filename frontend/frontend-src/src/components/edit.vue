...
<template>
	<div class="main-page" :class="[user.darkMode == true ? 'dark' : 'light ', editCoa]">
		<div style="height: 0" v-if="user.darkMode == true">
			<div class="stars"></div>
		...
		<div style="width: 100vw; height: 100vh;">
			<div
				:class="[user.darkMode ? 'profile-container edit-container profile-container-dark' : 'profile-container edit-container profile-container-light']">
				<div class="banner-profile edit-profile" :class=editCoa>
					EDIT YOUR PROFILE
				...
				<div class="grid" style="overflow: scroll; width: 100%; padding: 2rem 25% 2rem 25%;">
					...
					<div style="display: flex; justify-content: space-between; gap: 4px">
						...
						<button class="btn-coa order-btn nocolor-btn" @click="applyTheme('ORDER')">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
								id="Calque_1" x="0px" y="0px" viewBox="0 0 612 612"
								style="enable-background:new 0 0 612 612;position: initial" xml:space="preserve"
								class="coalition-flag--icon mx-auto">
						...
						<button class="btn-coa federation-btn nocolor-btn" @click="applyTheme('FEDERATION')">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
								id="Calque_1" x="0px" y="0px" viewBox="0 0 612 612"
								style="enable-background:new 0 0 612 612;position: initial" xml:space="preserve"
								class="coalition-flag--icon mx-auto">
						...
						<button class="btn-coa assembly-btn nocolor-btn" @click="applyTheme('ASSEMBLY')">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
								id="Calque_1" x="0px" y="0px" viewBox="0 0 612 612"
								style="enable-background:new 0 0 612 612;position: initial" xml:space="preserve"
								class="coalition-flag--icon mx-auto">
