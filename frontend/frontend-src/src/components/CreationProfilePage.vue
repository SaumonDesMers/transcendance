...
export default {
	data: function () {
		return {
			coalition_tab: ['Coalition', 'The Alliance', 'The Order', 'The Assembly', 'The Federation'],
			isDark: false,
		};
	},
	mounted() {
	...
	<div :class="[isDark ? 'centered-container-dark' : 'centered-container']">
		...
		<div class="actions">
			<div class="actions-content">
				<form ref="LoginForm" :class="[isDark ? 'btn dark' : 'btn brown']"><span><input placeholder value="Login"
							width="100%" /></span></form>
